      ...
      <div className="flex h-16 justify-between">
        <div className="flex">
          ...
          <div className="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
            ...
            <Link href="/dashboard" className="border-indigo-500 text-gray-900 inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium" aria-current="page">Dashboard</Link>
